                    ...
                    success: function(response){
                        ...
                        if(response.data.length !== 0){
                            for(var x = 0; x < templateObject.length; x++){
                                html += "<tr>"
                                +"<td>"+templateObject[x]['prefix']+"</td>"
                                +"<td>"+templateObject[x]['firstname']+"</td>"
                                +"<td>"+templateObject[x]['middlename']+"</td>"
                                +"<td>"+templateObject[x]['lastname']+"</td>"
                                +"<td>"
