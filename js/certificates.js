    ...
    function validateAllFieldsAndCreatePayloadForBirth(
        ...
        if(
            ...
            if(
                ...
                var metaContent = {
                    "born_on":(birth_born_on.getMonth() + 1)+"/"+birth_born_on.getDate()+"/"+birth_born_on.getFullYear(),
                    ...
                    "volume":birth_volume,
                    "page":birth_page,
                    "date_issued":(birth_date_issued.getMonth() + 1)+"/"+birth_date_issued.getDate()+"/"+birth_date_issued.getFullYear(),
                };
                payloadToCreate = {
